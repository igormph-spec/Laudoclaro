  ...
  return (
    <main style={{
      ...
      <div style={{
        ...
        <p style={{ color: '#6b7a99', fontSize: '0.95rem', marginBottom: '24px', lineHeight: '1.6' }}>
          Não foi possível processar o pagamento. Nenhum valor foi cobrado.<br /><br />
        ...
        <Link href="/" style={{
          ...
          textDecoration: 'none', fontSize: '1rem', marginBottom: '12px'
        }}>
          Tentar novamente
        </Link>
      </div>
